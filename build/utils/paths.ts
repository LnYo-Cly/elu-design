...
export const compRootPath = path.resolve(projectRootPath,'packages/components')
export const themeRootPath = path.resolve(projectRootPath,'packages/theme-chalk')